...
source_suffix = '.rst'
master_doc = 'index'
project = 'PyPkg Bintray 02'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = pypkg_bintray_02.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz-testing/pypkg_bintray_02/issues/%s', '#'),
    'pr': ('https://github.com/goerz-testing/pypkg_bintray_02/pull/%s', 'PR #'),
}
